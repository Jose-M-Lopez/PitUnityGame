...
public class CrawlerBehavior : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (distance < attackDistance)
        {
            ...
            GetComponent<Animation>().Play("C_Attack");
        ...
        else if (distance <= spotDistance)
        {
            ...
            GetComponent<Animation>().Play("C_Run");
        ...
        {
            //Idle state
            GetComponent<Animation>().Play("C_Idle");
    ...
    {
        health -= 8;
        GameControl.control.points += 5;

        if (health <= 0)
        {
            GameControl.control.points += 50;
